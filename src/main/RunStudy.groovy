...
class RunStudy {
	...
	public void initializeProject(String line){
		...
		int EditSameMC = Integer.parseInt(data[9])
		int SameSignatureCM = Integer.parseInt(data[10])
		int AddSameFd = Integer.parseInt(data[11])
		int EditSameFd = Integer.parseInt(data[12])
		int ExtendsList = Integer.parseInt(data[13])
